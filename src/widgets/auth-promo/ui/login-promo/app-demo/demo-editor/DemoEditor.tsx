  ...
  return (
    <div className={styles.editorCard}>
      ...
      <Typography
        ...
        className={classNames(styles.lastEdited,styles.bold)}
      >
        Последнее изменение: Алекс К. · 2 часа назад
      </Typography>
      <ul className={styles.tasks}>
        <li className={classNames(styles.task, styles.taskChecked)}>
          <Checkbox className={styles.checkbox} labelClassName={styles.checkboxLabel}>Описать все варианты кнопок и состояния</Checkbox>
        </li>
      ...
      <div className={styles.editorsWrapper}>
        ...
        <Typography className={classNames(styles.editorCount, styles.bold)}
                    variant='text-medium'
        >
